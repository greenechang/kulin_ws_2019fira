...
//#line 290 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(CameraParamsConfig::AbstractParamDescriptionConstPtr(new CameraParamsConfig::ParamDescription<int>("exposure_auto", "int", 0, "Auto Exposure", "{'enum_description': 'An enum to set size', 'enum': [{'srcline': 16, 'description': 'Exposure Auto', 'srcfile': '/home/robotis/Kulin_ws/src/ROBOTIS-OP3-Tools/op3_camera_setting_tool/cfg/CameraParams.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'auto'}, {'srcline': 17, 'description': 'Exposure Manual', 'srcfile': '/home/robotis/Kulin_ws/src/ROBOTIS-OP3-Tools/op3_camera_setting_tool/cfg/CameraParams.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'manual'}, {'srcline': 18, 'description': 'Exposure : Shutter priority', 'srcfile': '/home/robotis/Kulin_ws/src/ROBOTIS-OP3-Tools/op3_camera_setting_tool/cfg/CameraParams.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'shutter_priority'}, {'srcline': 19, 'description': 'Exposure : Aperture priority', 'srcfile': '/home/robotis/Kulin_ws/src/ROBOTIS-OP3-Tools/op3_camera_setting_tool/cfg/CameraParams.cfg', 'cconsttype': 'const int', 'value': 3, 'ctype': 'int', 'type': 'int', 'name': 'aperture_priority'}]}", &CameraParamsConfig::exposure_auto)));
//#line 290 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 16 "/home/robotis/Kulin_ws/src/ROBOTIS-OP3-Tools/op3_camera_setting_tool/cfg/CameraParams.cfg"
      const int CameraParams_auto = 0;
//#line 17 "/home/robotis/Kulin_ws/src/ROBOTIS-OP3-Tools/op3_camera_setting_tool/cfg/CameraParams.cfg"
      const int CameraParams_manual = 1;
//#line 18 "/home/robotis/Kulin_ws/src/ROBOTIS-OP3-Tools/op3_camera_setting_tool/cfg/CameraParams.cfg"
      const int CameraParams_shutter_priority = 2;
//#line 19 "/home/robotis/Kulin_ws/src/ROBOTIS-OP3-Tools/op3_camera_setting_tool/cfg/CameraParams.cfg"
